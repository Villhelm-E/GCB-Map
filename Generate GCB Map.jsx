...
for (i = 0; i < EF.length; i++) {
    selectColorRange(hexC(EF[i]), hexC(EF[i]));
    app.activeDocument.selection.fill(hexC(EFColor));
    app.activeDocument.selection.deselect();
}

//ET
for (i = 0; i < ET.length; i++) {
    selectColorRange(hexC(ET[i]), hexC(ET[i]));
    app.activeDocument.selection.fill(hexC(ETColor));
    app.activeDocument.selection.deselect();
}

//BWk
for (i = 0; i < BWk.length; i++) {
    selectColorRange(hexC(BWk[i]), hexC(BWk[i]));
    app.activeDocument.selection.fill(hexC(BWkColor));
    app.activeDocument.selection.deselect();
}

//BSk
for (i = 0; i < BSk.length; i++) {
    selectColorRange(hexC(BSk[i]), hexC(BSk[i]));
    app.activeDocument.selection.fill(hexC(BSkColor));
    app.activeDocument.selection.deselect();
}

//Dfc/Dsc/Dwc
for (i = 0; i < DfcDscDwc.length; i++) {
    selectColorRange(hexC(DfcDscDwc[i]), hexC(DfcDscDwc[i]));
    app.activeDocument.selection.fill(hexC(DfcDscDwcColor));
    app.activeDocument.selection.deselect();
}

//Cwb/Cwc
for (i = 0; i < CwbCwc.length; i++) {
    selectColorRange(hexC(CwbCwc[i]), hexC(CwbCwc[i]));
    app.activeDocument.selection.fill(hexC(CwbCwcColor));
    app.activeDocument.selection.deselect();
}

//Cfc
for (i = 0; i < Cfc.length; i++) {
    selectColorRange(hexC(Cfc[i]), hexC(Cfc[i]));
    app.activeDocument.selection.fill(hexC(CfcColor));
    app.activeDocument.selection.deselect();
}

//Cfb
for (i = 0; i < Cfb.length; i++) {
    selectColorRange(hexC(Cfb[i]), hexC(Cfb[i]));
    app.activeDocument.selection.fill(hexC(CfbColor));
    app.activeDocument.selection.deselect();
}

//Dfa/Dfb
for (i = 0; i < DfaDfb.length; i++) {
    selectColorRange(hexC(DfaDfb[i]), hexC(DfaDfb[i]));
    app.activeDocument.selection.fill(hexC(DfaDfbColor));
    app.activeDocument.selection.deselect();
}

//DsaDsb
for (i = 0; i < DsaDsb.length; i++) {
    selectColorRange(hexC(DsaDsb[i]), hexC(DsaDsb[i]));
    app.activeDocument.selection.fill(hexC(DsaDsbColor));
    app.activeDocument.selection.deselect();
}

//Dwa/Dwb
for (i = 0; i < DwaDwb.length; i++) {
    selectColorRange(hexC(DwaDwb[i]), hexC(DwaDwb[i]));
    app.activeDocument.selection.fill(hexC(DwaDwbColor));
    app.activeDocument.selection.deselect();
}

//Csb/Csc
for (i = 0; i < CsbCsc.length; i++) {
    selectColorRange(hexC(CsbCsc[i]), hexC(CsbCsc[i]));
    app.activeDocument.selection.fill(hexC(CsbCscColor));
    app.activeDocument.selection.deselect();
}

//BSh
for (i = 0; i < BSh.length; i++) {
    selectColorRange(hexC(BSh[i]), hexC(BSh[i]));
    app.activeDocument.selection.fill(hexC(BShColor));
    app.activeDocument.selection.deselect();
}

//BWh
for (i = 0; i < BWh.length; i++) {
    selectColorRange(hexC(BWh[i]), hexC(BWh[i]));
    app.activeDocument.selection.fill(hexC(BWhColor));
    app.activeDocument.selection.deselect();
}

//Cwa
for (i = 0; i < Cwa.length; i++) {
    selectColorRange(hexC(Cwa[i]), hexC(Cwa[i]));
    app.activeDocument.selection.fill(hexC(CwaColor));
    app.activeDocument.selection.deselect();
}

//Cfa
for (i = 0; i < Cfa.length; i++) {
    selectColorRange(hexC(Cfa[i]), hexC(Cfa[i]));
    app.activeDocument.selection.fill(hexC(CfaColor));
    app.activeDocument.selection.deselect();
}

//Csa
for (i = 0; i < Csa.length; i++) {
    selectColorRange(hexC(Csa[i]), hexC(Csa[i]));
    app.activeDocument.selection.fill(hexC(CsaColor));
    app.activeDocument.selection.deselect();
}

//Aw
for (i = 0; i < Aw.length; i++) {
    selectColorRange(hexC(Aw[i]), hexC(Aw[i]));
    app.activeDocument.selection.fill(hexC(AwColor));
    app.activeDocument.selection.deselect();
}

//Am
for (i = 0; i < Am.length; i++) {
    selectColorRange(hexC(Am[i]), hexC(Am[i]));
    app.activeDocument.selection.fill(hexC(AmColor));
    app.activeDocument.selection.deselect();
}

//ET
for (i = 0; i < Af.length; i++) {
    selectColorRange(hexC(Af[i]), hexC(Af[i]));
    app.activeDocument.selection.fill(hexC(AfColor));
    app.activeDocument.selection.deselect();
}